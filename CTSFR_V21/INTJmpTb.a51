...
extrn code (Exter_Int_0, Timer0_Int_0, Exter_Int_1, Timer1_Int_0, Timer2_Int_0)
...
;------------------------------------------------------------------------------
	...
	CSEG   AT 03H
	ljmp	 Exter_Int_0	;外部中断0,	

	CSEG   AT 0bH
    ljmp	 Timer0_Int_0	;定时器0中断,	

	CSEG   AT 13H
	ljmp	 Exter_Int_1	;外部中断1,

	CSEG   AT 1bH		
	ljmp	 Timer1_Int_0	;定时器1中断,

	CSEG   AT 2bH
	ljmp	 Timer2_Int_0	;定时器2中断,
